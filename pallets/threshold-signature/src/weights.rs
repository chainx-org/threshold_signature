...
impl<T: frame_system::Config> WeightInfo for SubstrateWeight<T> {
    fn generate_address() -> Weight {
        (474_714_000 as Weight).saturating_add(T::DbWeight::get().writes(1 as Weight))
    }
    fn verify_threshold_signature() -> Weight {
        (886_249_000 as Weight).saturating_add(T::DbWeight::get().reads(1 as Weight))
    }
}
...
impl WeightInfo for () {
    fn generate_address() -> Weight {
        (474_714_000 as Weight).saturating_add(RocksDbWeight::get().writes(1 as Weight))
    }
    fn verify_threshold_signature() -> Weight {
        (886_249_000 as Weight).saturating_add(RocksDbWeight::get().reads(1 as Weight))
    }
}
