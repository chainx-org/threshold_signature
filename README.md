...
- A threshold signature pallet to generate address and verify. Please refer to the more detailed introduction of [pallet](pallets/threshold-signature/README.md).
...
- Create a threshold signature address: This step is used to select parties to generate a threshold account.
  ...
  ![img](https://cdn.jsdelivr.net/gh/AAweidai/PictureBed@master/taproot/1630328549217-WechatIMG19.png)
...
- Initiate transaction: This step refers to the initial action of initiating a threshold-signature transaction, it’s different from the sign a transaction shown below.
  ...
  ![img](https://cdn.jsdelivr.net/gh/AAweidai/PictureBed@master/taproot/1630328784865-WechatIMG21.png)

  Entrance 2: Initiate transaction through group page

  ![img](https://cdn.jsdelivr.net/gh/AAweidai/PictureBed@master/taproot/1630328956646-WechatIMG20.png)
...
- Sign a transaction: This step refers to the action taken by other people to sign a specific transaction which someone had generated before.
  ...
  ![img](https://cdn.jsdelivr.net/gh/AAweidai/PictureBed@master/taproot/1630329110617-WechatIMG18.png)
